...
router.post('/tax-invoice/:tripID', authorize('admin'), createTaxInvoice);
router.post('/tax-invoice/:tripID/custom', authorize('admin'), createTaxInvoiceWithCustomTax);
router.post('/tax-invoice/:tripID/with-profile', authorize('admin'), createTaxInvoiceWithProfile);
router.post('/tax-invoice/:tripID/with-profile-custom', authorize('admin'), createTaxInvoiceWithProfileAndCustomTax);
router.get('/tax-invoice/eligible-bookings', authorize('admin', 'agent'), listEligibleBookings);
router.get('/tax-invoice/booking/:tripID', authorize('admin', 'agent'), getTaxInvoiceBooking);
...
router.get('/tax-invoice/date-range', authorize('admin'), listTaxInvoicesByDateRange);
...
router.put('/tax-invoice/:id', authorize('admin'), updateTaxInvoice);
