...
function setupServiceModalListeners() {
    ...
    // Hotel selection change handler - populate room types and promotions when hotel is selected
...
function calculateHotelPrice() {
    ...
    const promoDropdown = document.getElementById('promotion');
    const promoOption = promoDropdown?.options[promoDropdown.selectedIndex];
    const couponCode = promoOption?.getAttribute('data-promotion-code') || '';
